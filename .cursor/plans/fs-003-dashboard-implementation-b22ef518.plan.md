<!-- b22ef518-ec58-410f-81bc-483957a5e3e9 6ac55415-ba31-4e6b-a884-1e80234d9ae2 -->
...
- [ ] Установить зависимости recharts и date-fns
- [ ] Создать утилиты форматирования (числа, даты, проценты)
- [ ] Реализовать хук useStats для работы с API
- [ ] Создать компонент PeriodFilter с Tabs
- [ ] Обновить MetricCard для работы с API данными
- [ ] Реализовать TimelineChart с Recharts
- [ ] Обновить RecentDialogs для работы с API
- [ ] Обновить TopUsers для работы с API
- [ ] Создать компонент ErrorState для обработки ошибок
- [ ] Расширить DashboardSkeleton компонент
- [ ] Обновить страницу дашборда с интеграцией всех компонентов
- [ ] Добавить синхронизацию периода с URL query параметрами
- [ ] Провести ручное тестирование всех сценариев
- [ ] Оптимизировать производительность (мемоизация компонентов)
- [ ] Создать отчет о спринте FS-003
- [ ] Обновить roadmap со статусом FS-003